...
export default class ItemCard extends React.Component {
  ...
  addToCart = async () => {
     axios({
      method: "post",
      url:
        "http://secure-caverns-33420.herokuapp.com/api/component/addtoCart",
      data: {
    ...
    return (
      <Card style={transactionsStyle.btnTextHolder}>
        ...
        >
          ...
          <Text style={transactionsStyle.priceText1}>{this.state.item.totalPrice}</Text>
        ...
        >
          ...
          <Text style={transactionsStyle.descriptionText}> {this.state.item.description}</Text>
